...
export default function MarketsList(props) {
  ...
  return (
    <div className="m-2">
      <div className="h-16 grid grid-cols-[auto_100px_70px] justify-items-stretch font-medium items-center text-sm text-neutral-700">
        <div className="w-auto p-1">Coin</div>
        <div className="p-1 justify-self-end">Price</div>
        <div className="p-1 justify-self-end">24h</div>
      </div>
      {markets?.map((row) => (
        <div className="h-16 grid grid-cols-[auto_100px_70px] justify-items-stretch font-normal items-center text-sm text-neutral-700" key={row.id} >
          ...
          <div className={`p-1 justify-self-end 
            ${row.price_change_percentage_24h_in_currency > 0 ? "text-emerald-600" : "text-rose-600"}
          `}>
