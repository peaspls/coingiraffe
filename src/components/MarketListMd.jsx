...
export default function MarketsListMd(props) {
  ...
  return (
    <section className="dark:bg-darkbody text-neutral-600 dark:text-stone-200 p-2">
      ...
      <div>
        {markets?.map((row) => (
          <div className="dark:border-stone-800 grid-cols-[auto_100px_70px] min-h-[70px] pt-2 pb-2 grid justify-items-stretch font-normal items-center border-b first:border-t" key={row.id} >
              ...
              <div className="flex items-center ml-1">
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    <div className="bg-stone-100 dark:bg-gray-800 dark:text-neutral-400 text-sm px-1 py-0 mr-1 rounded">{row.market_cap_rank}</div>
                    <div className="dark:text-neutral-400 text-sm uppercase">{row.symbol}</div>
                  </div>
                </div>
              </div>
            </div>
