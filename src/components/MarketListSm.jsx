...
export default function MarketsListSm(props) {
  ...
  return (
    <section className="dark:bg-darkbody text-neutral-600 dark:text-stone-200 p-2">
      ...
      <div>
        {markets?.map((row) => (
          <div className="dark:border-stone-800 grid-cols-[auto_100px] min-h-[70px] pt-2 pb-2 grid justify-items-stretch font-normal items-center border-b first:border-t" key={row.id} >
