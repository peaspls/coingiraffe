...
export default function MarketsListSm(props) {
  ...
  return (
    <section className="m-2">
      <header className="grid-cols-[auto_100px] h-16 grid justify-items-stretch font-medium items-center text-base text-neutral-600">
        <div className="w-auto p-1">Coin</div>
        <div className="p-1 justify-self-end">24h</div>
      </header>
      <div>
        {markets?.map((row) => (
          <div className="grid-cols-[auto_100px] min-h-[70px] pt-2 pb-2 grid justify-items-stretch font-normal items-center border-b first:border-t" key={row.id} >
